...
Route::apiResource('hero-slides', \App\Http\Controllers\Api\HeroSlideController::class)->only(['index', 'show']);
...
Route::apiResource('information-sections', \App\Http\Controllers\Api\InformationSectionController::class)->only(['index', 'show']);

Route::post('careers/{career}/apply', [\App\Http\Controllers\Api\JobApplicationController::class, 'store']);
Route::apiResource('careers', \App\Http\Controllers\Api\CareerController::class)->only(['index', 'show']);
