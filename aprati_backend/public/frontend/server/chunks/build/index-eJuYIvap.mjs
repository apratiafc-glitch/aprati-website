...
import { ref, mergeProps, withCtx, createBlock, createTextVNode, openBlock, createVNode, useSSRContext } from 'file://D:/xammp/htdocs/aprati_web_backup/aprati_frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderComponent, ssrInterpolate, ssrRenderList } from 'file://D:/xammp/htdocs/aprati_web_backup/aprati_frontend/node_modules/vue/server-renderer/index.mjs';
import { a as useSeoMeta, c as useRouter } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/20 to-gray-50" }, _attrs))}><div class="px-4 sm:px-6 lg:px-8 py-6"><div class="mb-8 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl shadow-lg overflow-hidden"><div class="px-8 py-6 text-white"><div class="flex items-center justify-between"><div><h1 class="text-3xl font-bold mb-2">Welcome to Admin Panel 👋</h1><p class="text-blue-100">Manage your website content and settings</p></div><div class="flex items-center space-x-3"><button${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} class="flex items-center px-4 py-2 bg-blue-100 hover:bg-blue-200 disabled:bg-gray-100 text-blue-700 disabled:text-gray-400 rounded-lg transition-colors duration-200"><svg class="${ssrRenderClass([{ "animate-spin": loading.value }, "w-4 h-4 mr-2"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg>`);
      if (loading.value) {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/admin/profile",
        class: "flex items-center px-4 py-2 bg-green-100 hover:bg-green-200 text-green-700 rounded-lg transition-colors duration-200"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"${_scopeId}></path></svg> Update Profile `);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"${_scopeId}></path></svg> Go to Dashboard `);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                class: "w-4 h-4 mr-2",
      ...
      _push(`</div></div></div></div><div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8"><div class="bg-white rounded-lg shadow-lg p-6"><div class="flex items-center"><div class="p-3 rounded-full bg-blue-100"><svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div><div class="ml-4"><p class="text-sm font-medium text-gray-600">Information Sections</p><p class="text-2xl font-semibold text-gray-900">`);
      if (loading.value) {
        _push(`<span class="animate-pulse bg-gray-200 rounded w-8 h-8 inline-block"></span>`);
      } else {
        _push(`<span>${ssrInterpolate(stats.value.informationSections)}</span>`);
      }
      _push(`</p></div></div></div><div class="bg-white rounded-lg shadow-lg p-6"><div class="flex items-center"><div class="p-3 rounded-full bg-green-100"><svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg></div><div class="ml-4"><p class="text-sm font-medium text-gray-600">Total Brands</p><p class="text-2xl font-semibold text-gray-900">`);
      if (loading.value) {
        _push(`<span class="animate-pulse bg-gray-200 rounded w-8 h-8 inline-block"></span>`);
      } else {
        _push(`<span>${ssrInterpolate(stats.value.totalBrands)}</span>`);
      }
      _push(`</p></div></div></div><div class="bg-white rounded-lg shadow-lg p-6"><div class="flex items-center"><div class="p-3 rounded-full bg-green-100"><svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg></div><div class="ml-4"><p class="text-sm font-medium text-gray-600">Total Products</p><p class="text-2xl font-semibold text-gray-900">`);
      if (loading.value) {
        _push(`<span class="animate-pulse bg-gray-200 rounded w-8 h-8 inline-block"></span>`);
      } else {
        _push(`<span>${ssrInterpolate(stats.value.totalProducts)}</span>`);
      }
      _push(`</p></div></div></div><div class="bg-white rounded-lg shadow-lg p-6"><div class="flex items-center"><div class="p-3 rounded-full bg-emerald-100"><svg class="w-6 h-6 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg></div><div class="ml-4"><p class="text-sm font-medium text-gray-600">Total Users</p><p class="text-2xl font-semibold text-gray-900">`);
      if (loading.value) {
        _push(`<span class="animate-pulse bg-gray-200 rounded w-8 h-8 inline-block"></span>`);
      } else {
        _push(`<span>${ssrInterpolate(stats.value.totalUsers)}</span>`);
      }
      _push(`</p></div></div></div><div class="bg-white rounded-lg shadow-lg p-6"><div class="flex items-center"><div class="p-3 rounded-full bg-orange-100"><svg class="w-6 h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V8a2 2 0 012-2V6"></path></svg></div><div class="ml-4"><p class="text-sm font-medium text-gray-600">Job Applications</p><p class="text-2xl font-semibold text-gray-900">`);
      if (loading.value) {
        _push(`<span class="animate-pulse bg-gray-200 rounded w-8 h-8 inline-block"></span>`);
      } else {
        _push(`<span>${ssrInterpolate(stats.value.jobApplications)}</span>`);
      }
      _push(`</p></div></div></div><div class="bg-white rounded-lg shadow-lg p-6"><div class="flex items-center"><div class="p-3 rounded-full bg-cyan-100"><svg class="w-6 h-6 text-cyan-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg></div><div class="ml-4"><p class="text-sm font-medium text-gray-600">Website Visitors</p><p class="text-2xl font-semibold text-gray-900">`);
      if (loading.value) {
        _push(`<span class="animate-pulse bg-gray-200 rounded w-8 h-8 inline-block"></span>`);
      } else {
        _push(`<span>${ssrInterpolate(stats.value.totalVisitors)}</span>`);
      }
      _push(`</p><p class="text-xs text-gray-500 mt-1">`);
      if (loading.value) {
        _push(`<span class="animate-pulse bg-gray-200 rounded w-16 h-3 inline-block"></span>`);
      } else {
        _push(`<span>Today: ${ssrInterpolate(stats.value.todayVisitors)}</span>`);
      }
      _push(`</p></div></div></div></div><div class="bg-white rounded-lg shadow-lg p-6 mb-8"><h2 class="text-xl font-bold text-gray-900 mb-6">Quick Actions</h2><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-2 bg-blue-100 rounded-lg mr-4"${_scopeId}><svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2h4a1 1 0 110 2h-1v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6H2a1 1 0 110-2h4z"${_scopeId}></path></svg></div><div${_scopeId}><h3 class="font-semibold text-gray-900"${_scopeId}>Favicon Settings</h3><p class="text-sm text-gray-600"${_scopeId}>Manage website favicon and branding</p></div>`);
          } else {
            return [
              createVNode("div", { class: "p-2 bg-blue-100 rounded-lg mr-4" }, [
                (openBlock(), createBlock("svg", {
                  ...
                  createVNode("path", {
                    ...
                    "stroke-linejoin": "round",
                    "stroke-width": "2",
                    d: "M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2h4a1 1 0 110 2h-1v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6H2a1 1 0 110-2h4z"
                  })
                ]))
              ]),
              createVNode("div", null, [
                createVNode("h3", { class: "font-semibold text-gray-900" }, "Favicon Settings"),
                createVNode("p", { class: "text-sm text-gray-600" }, "Manage website favicon and branding")
              ])
            ];
          }
        }),
      ...
      _push(`</div></div><div class="bg-white rounded-lg shadow-lg p-6"><h2 class="text-xl font-bold text-gray-900 mb-6">Recent Activity</h2><div class="space-y-4"><!--[-->`);
      ssrRenderList(recentActivity.value, (activity) => {
        _push(`<div class="flex items-center p-4 border border-gray-200 rounded-lg"><div class="p-2 bg-gray-100 rounded-lg mr-4"><svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div><div class="flex-1"><p class="text-sm font-medium text-gray-900">${ssrInterpolate(activity.action)}</p><p class="text-sm text-gray-600">${ssrInterpolate(activity.time)}</p></div></div>`);
      });
...
//# sourceMappingURL=index-eJuYIvap.mjs.map
