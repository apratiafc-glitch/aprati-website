import * as e$1 from 'file://D:/xammp/htdocs/aprati_web_backup/aprati_frontend/node_modules/vue/index.mjs';
import { ref, reactive, computed, mergeProps, unref, defineComponent, withCtx, createVNode, createTextVNode, toDisplayString, withModifiers, createBlock, createCommentVNode, withDirectives, vModelText, openBlock, vModelCheckbox, watchEffect, onMounted, provide, inject, h as h$1, onUnmounted, watch, normalizeClass, getCurrentInstance, Teleport, Fragment, cloneVNode, shallowRef, nextTick, useSSRContext } from 'file://D:/xammp/htdocs/aprati_web_backup/aprati_frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseContain } from 'file://D:/xammp/htdocs/aprati_web_backup/aprati_frontend/node_modules/vue/server-renderer/index.mjs';
import { PlusIcon, DocumentTextIcon, CheckCircleIcon, XCircleIcon, PhotoIcon } from 'file://D:/xammp/htdocs/aprati_web_backup/aprati_frontend/node_modules/@heroicons/vue/24/outline/esm/index.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stats = computed(() => ({
      ...
      active: sections.value.filter((s3) => s3.is_active).length,
      inactive: sections.value.filter((s3) => !s3.is_active).length,
      withImages: sections.value.filter((s3) => s3.image_url && !s3.image_url.includes("default-info.svg")).length
    }));
    const getAuthToken = () => {
    ...
    const handleImageChange = (event) => {
      ...
      if (file) {
        ...
        reader.onload = (e2) => {
          imagePreview.value = e2.target.result;
        };
    ...
    const submitForm = async () => {
      ...
      try {
        ...
        const url = editingSection.value ? `https://sdev.apratifoods.asia/api/admin/information-sections/${editingSection.value.id}` : "https://sdev.apratifoods.asia/api/admin/information-sections";
        const method = "POST";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gray-50" }, _attrs))}><div class="bg-white shadow"><div class="px-4 sm:px-6 lg:px-8"><div class="flex justify-between h-16"><div class="flex items-center"><h1 class="text-xl font-semibold text-gray-900">Information Sections Management</h1></div><div class="flex items-center space-x-4"><button class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">`);
      _push(ssrRenderComponent(unref(PlusIcon), { class: "h-4 w-4 mr-2" }, null, _parent));
      _push(` Add New Section </button></div></div></div></div><div class="px-4 sm:px-6 lg:px-8 py-6"><div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6"><div class="bg-white overflow-hidden shadow rounded-lg"><div class="p-5"><div class="flex items-center"><div class="flex-shrink-0">`);
      _push(ssrRenderComponent(unref(DocumentTextIcon), { class: "h-6 w-6 text-gray-400" }, null, _parent));
      _push(`</div><div class="ml-5 w-0 flex-1"><dl><dt class="text-sm font-medium text-gray-500 truncate">Total Sections</dt><dd class="text-lg font-medium text-gray-900">${ssrInterpolate(stats.value.total)}</dd></dl></div></div></div></div><div class="bg-white overflow-hidden shadow rounded-lg"><div class="p-5"><div class="flex items-center"><div class="flex-shrink-0">`);
      _push(ssrRenderComponent(unref(CheckCircleIcon), { class: "h-6 w-6 text-green-400" }, null, _parent));
      _push(`</div><div class="ml-5 w-0 flex-1"><dl><dt class="text-sm font-medium text-gray-500 truncate">Active</dt><dd class="text-lg font-medium text-gray-900">${ssrInterpolate(stats.value.active)}</dd></dl></div></div></div></div><div class="bg-white overflow-hidden shadow rounded-lg"><div class="p-5"><div class="flex items-center"><div class="flex-shrink-0">`);
      _push(ssrRenderComponent(unref(XCircleIcon), { class: "h-6 w-6 text-red-400" }, null, _parent));
      _push(`</div><div class="ml-5 w-0 flex-1"><dl><dt class="text-sm font-medium text-gray-500 truncate">Inactive</dt><dd class="text-lg font-medium text-gray-900">${ssrInterpolate(stats.value.inactive)}</dd></dl></div></div></div></div><div class="bg-white overflow-hidden shadow rounded-lg"><div class="p-5"><div class="flex items-center"><div class="flex-shrink-0">`);
      _push(ssrRenderComponent(unref(PhotoIcon), { class: "h-6 w-6 text-blue-400" }, null, _parent));
      _push(`</div><div class="ml-5 w-0 flex-1"><dl><dt class="text-sm font-medium text-gray-500 truncate">With Images</dt><dd class="text-lg font-medium text-gray-900">${ssrInterpolate(stats.value.withImages)}</dd></dl></div></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md"><div class="px-4 py-5 sm:px-6"><h3 class="text-lg leading-6 font-medium text-gray-900">Information Sections</h3><p class="mt-1 max-w-2xl text-sm text-gray-500">Manage your website&#39;s information sections</p></div>`);
      if (loading.value) {
        _push(`<div class="px-4 py-8"><div class="flex justify-center"><div class="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div></div></div>`);
      } else if (sections.value.length > 0) {
        _push(`<ul class="divide-y divide-gray-200"><!--[-->`);
        ssrRenderList(sections.value, (section) => {
          _push(`<li class="px-4 py-4 hover:bg-gray-50"><div class="flex items-center justify-between"><div class="flex items-center space-x-4"><div class="flex-shrink-0"><img${ssrRenderAttr("src", section.image_url)}${ssrRenderAttr("alt", section.title)} class="h-16 w-16 rounded-lg object-cover"></div><div class="min-w-0 flex-1"><div class="flex items-center space-x-2"><h4 class="text-sm font-medium text-gray-900">${ssrInterpolate(section.title)}</h4><span class="${ssrRenderClass([
            "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium",
            section.is_active ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
          ])}">${ssrInterpolate(section.is_active ? "Active" : "Inactive")}</span></div><p class="text-sm text-gray-500 mt-1">${ssrInterpolate(truncateText(section.description, 120))}</p><div class="flex items-center space-x-4 mt-2 text-xs text-gray-400"><span>Sort: ${ssrInterpolate(section.sort_order)}</span><span>Created: ${ssrInterpolate(formatDate(section.created_at))}</span><span>By: ${ssrInterpolate(section.created_by)}</span></div></div></div><div class="flex items-center space-x-2"><button class="${ssrRenderClass([
            "inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded-md",
            section.is_active ? "text-red-700 bg-red-100 hover:bg-red-200" : "text-green-700 bg-green-100 hover:bg-green-200"
          ])}">${ssrInterpolate(section.is_active ? "Deactivate" : "Activate")}</button><button class="inline-flex items-center px-3 py-1 border border-gray-300 text-xs font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"> Edit </button><button class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded-md text-red-700 bg-red-100 hover:bg-red-200"> Delete </button></div></div></li>`);
        });
        _push(`<!--]--></ul>`);
      } else {
        _push(`<div class="px-4 py-8 text-center">`);
        _push(ssrRenderComponent(unref(DocumentTextIcon), { class: "mx-auto h-12 w-12 text-gray-400" }, null, _parent));
        _push(`<h3 class="mt-2 text-sm font-medium text-gray-900">No information sections</h3><p class="mt-1 text-sm text-gray-500">Get started by creating a new information section.</p><div class="mt-6"><button class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">`);
        _push(ssrRenderComponent(unref(PlusIcon), { class: "h-4 w-4 mr-2" }, null, _parent));
        _push(` Add Information Section </button></div></div>`);
      }
      _push(`</div></div>`);
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(Ge), { class: "relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<form${_scopeId4}><div${_scopeId4}><div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-100"${_scopeId4}>`);
                              _push5(ssrRenderComponent(unref(DocumentTextIcon), { class: "h-6 w-6 text-blue-600" }, null, _parent5, _scopeId4));
                              ...
                              _push5(ssrRenderComponent(unref(Ve), {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`${ssrInterpolate(editingSection.value ? "Edit Information Section" : "Create Information Section")}`);
                                  } else {
                                    return [
                                      createTextVNode(toDisplayString(editingSection.value ? "Edit Information Section" : "Create Information Section"), 1)
                                    ];
                                  }
                                }),
                                _: 1
                              }, _parent5, _scopeId4));
                              _push5(`</div></div><div class="mt-5 space-y-4"${_scopeId4}><div${_scopeId4}><label for="title" class="block text-sm font-medium text-gray-700"${_scopeId4}>Title</label><input id="title"${ssrRenderAttr("value", form.title)} type="text" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" placeholder="Enter section title"${_scopeId4}></div><div${_scopeId4}><label for="description" class="block text-sm font-medium text-gray-700"${_scopeId4}>Description</label><textarea id="description" rows="3" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" placeholder="Enter section description"${_scopeId4}>${ssrInterpolate(form.description)}</textarea></div><div${_scopeId4}><label for="image" class="block text-sm font-medium text-gray-700"${_scopeId4}>Image</label><input id="image" type="file" accept="image/*" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"${_scopeId4}><p class="mt-1 text-xs text-gray-500"${_scopeId4}>PNG, JPG, GIF up to 2MB</p></div>`);
                              if (imagePreview.value) {
                                _push5(`<div class="mt-2"${_scopeId4}><img${ssrRenderAttr("src", imagePreview.value)} alt="Preview" class="h-32 w-32 object-cover rounded-lg"${_scopeId4}></div>`);
                              } else {
                                _push5(`<!---->`);
                              }
                              _push5(`<div${_scopeId4}><label for="sort_order" class="block text-sm font-medium text-gray-700"${_scopeId4}>Sort Order</label><input id="sort_order"${ssrRenderAttr("value", form.sort_order)} type="number" min="0" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" placeholder="0"${_scopeId4}></div><div class="flex items-center"${_scopeId4}><input id="is_active"${ssrIncludeBooleanAttr(Array.isArray(form.is_active) ? ssrLooseContain(form.is_active, null) : form.is_active) ? " checked" : ""} type="checkbox" class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"${_scopeId4}><label for="is_active" class="ml-2 block text-sm text-gray-900"${_scopeId4}>Active</label></div></div><div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3"${_scopeId4}><button type="submit"${ssrIncludeBooleanAttr(submitting.value) ? " disabled" : ""} class="inline-flex w-full justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 sm:col-start-2 disabled:opacity-50"${_scopeId4}>`);
                              if (submitting.value) {
                                _push5(`<span class="flex items-center"${_scopeId4}><div class="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"${_scopeId4}></div> ${ssrInterpolate(editingSection.value ? "Updating..." : "Creating...")}</span>`);
                              } else {
                                _push5(`<span${_scopeId4}>${ssrInterpolate(editingSection.value ? "Update" : "Create")}</span>`);
                              }
                              _push5(`</button><button type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:col-start-1 sm:mt-0"${_scopeId4}> Cancel </button></div></form>`);
                            } else {
                              return [
                                createVNode("form", {
                                  ...
                                  createVNode("div", null, [
                                    createVNode("div", { class: "mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-100" }, [
                                      createVNode(unref(DocumentTextIcon), { class: "h-6 w-6 text-blue-600" })
                                    ]),
                                  ...
                                  createVNode("div", { class: "mt-5 space-y-4" }, [
                                    createVNode("div", null, [
                                      createVNode("label", {
                                        for: "title",
                                  ...
                                  createVNode("div", { class: "mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3" }, [
                                    createVNode("button", {
                                      ...
                                      submitting.value ? (openBlock(), createBlock("span", {
                                        ...
                                        createVNode("div", { class: "animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2" }),
                                        createTextVNode(" " + toDisplayString(editingSection.value ? "Updating..." : "Creating..."), 1)
                                      ])) : (openBlock(), createBlock("span", { key: 1 }, toDisplayString(editingSection.value ? "Update" : "Create"), 1))
                                    ], 8, ["disabled"]),
                                    createVNode("button", {
                                      type: "button",
                                      onClick: closeModal,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/information-sections.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=information-sections-CBXwwok5.mjs.map
